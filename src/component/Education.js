...
const Details = ({ type, time, place, info }) => {
  ...
  return (
    <li
      ref={ref}
      className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto cursor-pointer flex flex-col items-center justify-between"
    >
...
const Education = () => {
  ...
  return (
    <div className="my-64">
      <h2 className="font-bold text-8xl mb-32 w-full text-center cursor-pointer">Education</h2>
